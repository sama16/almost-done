  ...
  return (
    <div>
      ...
      >
        ...
        >
          Our team decided to create this app to make it easier for you to
          manage your time and to be able to plan everything for your day,
          hoping that you will have a great experience using it. So know more
          about our team.
        </p>
      </div>
      ...
      <div>
        ...
        >
          ...
          <h2 style={{ fontSize: "18px" }}>✉️ GitItDone@gmail.com</h2>
          <h2 style={{ fontSize: "18px" }}>📞 08288765222</h2>
        </div>
        ...
        >
          <a
            href="https://www.facebook.com/tala.mohanna.7"
            className="icon1"
